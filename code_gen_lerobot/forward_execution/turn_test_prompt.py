...
{{
  ...
  "overhead_waypoints": [
    ...
    ...
    {{"point_2d": [y, x], "label": "wpN: <description>", "reasoning": "..."}}
  ],
  "sideview_waypoints": [
    {{"point_2d": [y, x], "label": "wp1: <description>", "reasoning": "..."}},
    {{"point_2d": [y, x], "label": "wp2: <description>", "reasoning": "..."}},
...
{{
  "selected_points": ["<label of selected point 1>", "<label of selected point 2>"],
  "overhead_waypoints": [
    {{"point_2d": [y, x], "label": "start: <description>", "reasoning": "..."}},
    {{"point_2d": [y, x], "label": "waypoint: <description>", "reasoning": "..."}},
    ...
    {{"point_2d": [y, x], "label": "end: <description>", "reasoning": "..."}}
  ]
}}
```
...
- Typically 5-8 waypoints are sufficient per view.
